...
4. 点击 [备份Steam凭证]  ← 以后 Steam 不用重新登录（每次登陆后都需要更新一次凭证）
5. 启动游戏 → 切回工具 → 点击 [发现存档]（目前大部分都无法自动找到，可以手动）
6. 点击 [备份存档]
```
...
```
登录云电脑 → 双击 GameDataKeeper.exe → [备份] → 开玩
                                              ↓
                      [恢复] ← 游戏结束 ←──┘
```
...
<img width="1056" height="828" alt="image" src="https://github.com/user-attachments/assets/76213dc3-9b83-4c02-b29d-5208580032e3" />
