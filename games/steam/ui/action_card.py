...
class ActionCard(Card):
    def __init__(self, parent, *, on_backup_saves, on_restore_saves,
                 on_backup_cred, on_restore_cred):
        ...
        r2 = tk.Frame(self, bg="#f5f5f5"); r2.pack(fill="x", pady=2)
        btn("备份Steam凭证", on_backup_cred).pack(side="left", padx=2)
        btn("恢复Steam凭证", on_restore_cred).pack(side="left", padx=2)
